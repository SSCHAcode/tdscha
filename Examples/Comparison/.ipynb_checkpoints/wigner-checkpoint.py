...
if USE_FOURTH_ORDER and USE_FOURTH_ORDER:
    SAVE_FOLDER = "data_wigner_md_{}".format(MODE_PERTURBATION_ID) # The folder in which the data are saved
elif not USE_FOURTH_ORDER:
    SAVE_FOLDER = "data_wigner_no_D4_md_{}".format(MODE_PERTURBATION_ID) # The folder in which the data are saved
else:
    SAVE_FOLDER = "data_wigner_harm_md_{}".format(MODE_PERTURBATION_ID) # The folder in which the data are saved
